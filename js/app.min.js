...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]=e[r]);return t.default=e,t}function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,r=Array(e.length);t<e.length;t++)r[t]=e[t];return r}return Array.from(e)}function drawMap(e,t){var r=L.map(e,{center:[41.87,-87.9],zoom:10,minZoom:3,maxZoom:16,maxBounds:[[40.5,-89.5],[43,-86.5]],scrollWheelZoom:!1});L.tileLayer.provider("CartoDB.Positron").addTo(r);var o=new L.DivIcon({className:"map__location-icon-user",iconSize:[6,6]});t.forEach(function(e){var t=buildPopup(e);new L.Marker([parseFloat(e.lat),parseFloat(e.lng)],{icon:L.dataDivIcon({className:"map__location-icon",html:"<span></span>",iconSize:10,data:{type:createValue(e.type),price:e.price.length}})}).addTo(r).bindPopup(t)}),document.getElementById("search-address-submit").addEventListener("click",function(e){e.preventDefault();var t=document.getElementById("search-address").value;utils.spinner("spinner"),(0,_getCoord2.default)(t).then(function(e){var t=JSON.parse(e).resourceSets[0];t.estimatedTotal>0&&(utils.triggerWarning("clear"),userCoordinates={address:t.resources[0].name,coordinates:[t.resources[0].geocodePoints[0].coordinates[1],t.resources[0].geocodePoints[0].coordinates[0]]})},function(e){}).then(function(e){L.marker([userCoordinates.coordinates[1],userCoordinates.coordinates[0]],{icon:o}).addTo(r),r.flyTo([userCoordinates.coordinates[1],userCoordinates.coordinates[0]],12),console.log(userCoordinates.coordinates)}).then(function(e){utils.spinner("arrow")}).catch(function(e){console.log("error",e,e.stack)})})}function buildPopup(e){return'<div class="popup">\n\t\t\t\t\t\t<h4><span>'+e.name+"</h4>\n\t\t\t\t\t\t<ul>\n\t\t\t\t\t\t\t<li>"+e.type+" | "+e.cuisine+"</li>\n\t\t\t\t\t\t\t<li>Price: "+e.price+"</li>\n\t\t\t\t\t\t\t<li class='list-ital'>"+e.address+", "+e.city+"</li>\n\t\t\t\t\t\t\t<li><a href=\"javascript: document.getElementById('"+e.id+"').scrollIntoView({behavior:'smooth'});\">More info</a></li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>"}function populateDropdown(e){for(var t=document.querySelector("#cuisineTypeSelect"),r=[].concat(_toConsumableArray(new Set(e.map(function(e){return e.type})))).sort(),o=0;o<r.length;o++){var n=document.createElement("option"),a=r[o],i=createValue(a);n.text=a,n.value=i,t.appendChild(n)}}function formatListData(){var e=document.querySelectorAll(".restaurant-container"),t=!0,r=!1,o=void 0;try{for(var n,a=e[Symbol.iterator]();!(t=(n=a.next()).done);t=!0){var i=n.value,l=i.dataset.type;i.dataset.type=createValue(l)}}catch(e){r=!0,o=e}finally{try{!t&&a.return&&a.return()}finally{if(r)throw o}}}function createValue(e){return e.toLowerCase().split("").filter(function(e){return" "!==e&&"/"!==e}).join("")}function renderShowHide(){var e=document.querySelectorAll(".map__location-icon"),t=0,r=!0,o=!1,n=void 0;try{for(var a,i=e[Symbol.iterator]();!(r=(a=i.next()).done);r=!0){var l=a.value;"all"!==filterState.type&&filterState.type!==l.dataset.type||"all"!==filterState.price&&filterState.price!==l.dataset.price?l.style.display="none":l.style.display="block"}}catch(e){o=!0,n=e}finally{try{!r&&i.return&&i.return()}finally{if(o)throw n}}var c=document.querySelectorAll(".restaurant-container"),u=!0,s=!1,d=void 0;try{for(var p,y=c[Symbol.iterator]();!(u=(p=y.next()).done);u=!0){var f=p.value;"all"!==filterState.type&&filterState.type!==f.dataset.type||"all"!==filterState.price&&filterState.price!==f.dataset.price?f.style.display="none":(f.style.display="block",t++)}}catch(e){s=!0,d=e}finally{try{!u&&y.return&&y.return()}finally{if(s)throw d}}100===t?document.querySelector("#count-p").style.display="none":1===t?(document.querySelector("#count-p").style.display="inline-block",document.querySelector("#count-p").innerText="Displaying 1 result"):(document.querySelector("#count-p").style.display="inline-block",document.querySelector("#count-p").innerText="Displaying "+t+" results");var m=document.querySelector(".leaflet-popup-close-button");m&&m.click(),pymChild.sendHeight()}var _leaflet=require("leaflet"),L=_interopRequireWildcard(_leaflet),_getCoord=require("./get-coord.js"),_getCoord2=_interopRequireDefault(_getCoord),_geocodingUtils=require("./geocoding-utils.js"),utils=_interopRequireWildcard(_geocodingUtils);require("leaflet-providers");var userCoordinates={};L.DataDivIcon=L.DivIcon.extend({createIcon:function(e){var t=L.DivIcon.prototype.createIcon.call(this,e);if(this.options.data)for(var r in this.options.data)t.dataset[r]=this.options.data[r];return t}}),L.dataDivIcon=function(e){return new L.DataDivIcon(e)},document.addEventListener("DOMContentLoaded",function(e){var t=document.querySelector("#takeout-map"),r=window.takeout;Promise.all([r]).then(function(e){drawMap(t,e[0]),populateDropdown(e[0]),formatListData()})});var filterState={type:"all",price:"all"};document.querySelector("#cuisineTypeSelect").addEventListener("change",function(e){filterState.type=e.target.value,renderShowHide()}),document.querySelector("#priceSelect").addEventListener("change",function(e){filterState.price=e.target.value,renderShowHide()});
},{"./geocoding-utils.js":2,"./get-coord.js":3,"leaflet":undefined,"leaflet-providers":undefined}],2:[function(require,module,exports){
"use strict";function triggerWarning(e,r){"trigger"==e?(document.querySelector(".profile-lookup__error-message").innerHTML=r,document.querySelector(".profile-lookup").classList.add("profile-lookup--error")):"clear"==e&&document.querySelector(".profile-lookup").classList.remove("profile-lookup--error")}function spinner(e){for(var r=document.querySelectorAll(".submit-icon"),o=0;o<r.length;o++){var i=r[o];i.classList.contains("submit-icon--"+e)?i.classList.add("submit-icon--visible"):i.classList.remove("submit-icon--visible")}}module.exports={triggerWarning:triggerWarning,spinner:spinner};
},{}],3:[function(require,module,exports){
"use strict";function getCoord(o){return new Promise(function(r,e){var t="https://qyf1ag22mj.execute-api.us-east-1.amazonaws.com/production/locations?q="+encodeURI(o)+"&userLocation=41.8337329,-87.7321555",n=((0,_d.json)(t),new XMLHttpRequest);n.open("GET",t),n.onload=function(){200==n.status?r(n.response):(e(Error("ERROR!")),e(TypeError("TYPE ERROR!")))},n.onerror=function(){e(Error("Network Error"))},n.send()})}var _d=require("d3");module.exports=getCoord;
},{"d3":34}],4:[function(require,module,exports){
...
},{"d3-array":4}],10:[function(require,module,exports){
...
},{"d3-dispatch":11,"d3-quadtree":23,"d3-timer":31}],17:[function(require,module,exports){
...
},{"d3-color":8}],21:[function(require,module,exports){
!function(t,i){"object"==typeof exports&&"undefined"!=typeof module?i(exports):"function"==typeof define&&define.amd?define(["exports"],i):(t=t||self,i(t.d3=t.d3||{}))}(this,function(t){"use strict";function i(){this._x0=this._y0=this._x1=this._y1=null,this._=""}function s(){return new i}const h=Math.PI,e=2*h,_=e-1e-6;i.prototype=s.prototype={constructor:i,moveTo:function(t,i){this._+="M"+(this._x0=this._x1=+t)+","+(this._y0=this._y1=+i)},closePath:function(){null!==this._x1&&(this._x1=this._x0,this._y1=this._y0,this._+="Z")},lineTo:function(t,i){this._+="L"+(this._x1=+t)+","+(this._y1=+i)},quadraticCurveTo:function(t,i,s,h){this._+="Q"+ +t+","+ +i+","+(this._x1=+s)+","+(this._y1=+h)},bezierCurveTo:function(t,i,s,h,e,_){this._+="C"+ +t+","+ +i+","+ +s+","+ +h+","+(this._x1=+e)+","+(this._y1=+_)},arcTo:function(t,i,s,e,_){t=+t,i=+i,s=+s,e=+e,_=+_;var n=this._x1,o=this._y1,r=s-t,a=e-i,u=n-t,c=o-i,f=u*u+c*c;if(_<0)throw new Error("negative radius: "+_);if(null===this._x1)this._+="M"+(this._x1=t)+","+(this._y1=i);else if(f>1e-6)if(Math.abs(c*r-a*u)>1e-6&&_){var x=s-n,y=e-o,M=r*r+a*a,l=x*x+y*y,d=Math.sqrt(M),p=Math.sqrt(f),v=_*Math.tan((h-Math.acos((M+f-l)/(2*d*p)))/2),b=v/p,w=v/d;Math.abs(b-1)>1e-6&&(this._+="L"+(t+b*u)+","+(i+b*c)),this._+="A"+_+","+_+",0,0,"+ +(c*x>u*y)+","+(this._x1=t+w*r)+","+(this._y1=i+w*a)}else this._+="L"+(this._x1=t)+","+(this._y1=i);else;},arc:function(t,i,s,n,o,r){t=+t,i=+i,s=+s,r=!!r;var a=s*Math.cos(n),u=s*Math.sin(n),c=t+a,f=i+u,x=1^r,y=r?n-o:o-n;if(s<0)throw new Error("negative radius: "+s);null===this._x1?this._+="M"+c+","+f:(Math.abs(this._x1-c)>1e-6||Math.abs(this._y1-f)>1e-6)&&(this._+="L"+c+","+f),s&&(y<0&&(y=y%e+e),y>_?this._+="A"+s+","+s+",0,1,"+x+","+(t-a)+","+(i-u)+"A"+s+","+s+",0,1,"+x+","+(this._x1=c)+","+(this._y1=f):y>1e-6&&(this._+="A"+s+","+s+",0,"+ +(y>=h)+","+x+","+(this._x1=t+s*Math.cos(o))+","+(this._y1=i+s*Math.sin(o))))},rect:function(t,i,s,h){this._+="M"+(this._x0=this._x1=+t)+","+(this._y0=this._y1=+i)+"h"+ +s+"v"+ +h+"h"+-s+"Z"},toString:function(){return this._}},t.path=s,Object.defineProperty(t,"__esModule",{value:!0})});
...
!function(t,i){"object"==typeof exports&&"undefined"!=typeof module?i(exports):"function"==typeof define&&define.amd?define(["exports"],i):(t=t||self,i(t.d3=t.d3||{}))}(this,function(t){"use strict";function i(t){const i=+this._x.call(null,t),e=+this._y.call(null,t);return n(this.cover(i,e),i,e,t)}function n(t,i,n,e){if(isNaN(i)||isNaN(n))return t;var r,s,h,o,a,u,l,_,f,c=t._root,x={data:e},y=t._x0,d=t._y0,v=t._x1,p=t._y1;if(!c)return t._root=x,t;for(;c.length;)if((u=i>=(s=(y+v)/2))?y=s:v=s,(l=n>=(h=(d+p)/2))?d=h:p=h,r=c,!(c=c[_=l<<1|u]))return r[_]=x,t;if(o=+t._x.call(null,c.data),a=+t._y.call(null,c.data),i===o&&n===a)return x.next=c,r?r[_]=x:t._root=x,t;do{r=r?r[_]=new Array(4):t._root=new Array(4),(u=i>=(s=(y+v)/2))?y=s:v=s,(l=n>=(h=(d+p)/2))?d=h:p=h}while((_=l<<1|u)==(f=(a>=h)<<1|o>=s));return r[f]=c,r[_]=x,t}function e(t){var i,e,r,s,h=t.length,o=new Array(h),a=new Array(h),u=1/0,l=1/0,_=-1/0,f=-1/0;for(e=0;e<h;++e)isNaN(r=+this._x.call(null,i=t[e]))||isNaN(s=+this._y.call(null,i))||(o[e]=r,a[e]=s,r<u&&(u=r),r>_&&(_=r),s<l&&(l=s),s>f&&(f=s));if(u>_||l>f)return this;for(this.cover(u,l).cover(_,f),e=0;e<h;++e)n(this,o[e],a[e],t[e]);return this}function r(t,i){if(isNaN(t=+t)||isNaN(i=+i))return this;var n=this._x0,e=this._y0,r=this._x1,s=this._y1;if(isNaN(n))r=(n=Math.floor(t))+1,s=(e=Math.floor(i))+1;else{for(var h,o,a=r-n||1,u=this._root;n>t||t>=r||e>i||i>=s;)switch(o=(i<e)<<1|t<n,h=new Array(4),h[o]=u,u=h,a*=2,o){case 0:r=n+a,s=e+a;break;case 1:n=r-a,s=e+a;break;case 2:r=n+a,e=s-a;break;case 3:n=r-a,e=s-a}this._root&&this._root.length&&(this._root=u)}return this._x0=n,this._y0=e,this._x1=r,this._y1=s,this}function s(){var t=[];return this.visit(function(i){if(!i.length)do{t.push(i.data)}while(i=i.next)}),t}function h(t){return arguments.length?this.cover(+t[0][0],+t[0][1]).cover(+t[1][0],+t[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]}function o(t,i,n,e,r){this.node=t,this.x0=i,this.y0=n,this.x1=e,this.y1=r}function a(t,i,n){var e,r,s,h,a,u,l,_=this._x0,f=this._y0,c=this._x1,x=this._y1,y=[],d=this._root;for(d&&y.push(new o(d,_,f,c,x)),null==n?n=1/0:(_=t-n,f=i-n,c=t+n,x=i+n,n*=n);u=y.pop();)if(!(!(d=u.node)||(r=u.x0)>c||(s=u.y0)>x||(h=u.x1)<_||(a=u.y1)<f))if(d.length){var v=(r+h)/2,p=(s+a)/2;y.push(new o(d[3],v,p,h,a),new o(d[2],r,p,v,a),new o(d[1],v,s,h,p),new o(d[0],r,s,v,p)),(l=(i>=p)<<1|t>=v)&&(u=y[y.length-1],y[y.length-1]=y[y.length-1-l],y[y.length-1-l]=u)}else{var w=t-+this._x.call(null,d.data),N=i-+this._y.call(null,d.data),g=w*w+N*N;if(g<n){var A=Math.sqrt(n=g);_=t-A,f=i-A,c=t+A,x=i+A,e=d.data}}return e}function u(t){if(isNaN(s=+this._x.call(null,t))||isNaN(h=+this._y.call(null,t)))return this;var i,n,e,r,s,h,o,a,u,l,_,f,c=this._root,x=this._x0,y=this._y0,d=this._x1,v=this._y1;if(!c)return this;if(c.length)for(;;){if((u=s>=(o=(x+d)/2))?x=o:d=o,(l=h>=(a=(y+v)/2))?y=a:v=a,i=c,!(c=c[_=l<<1|u]))return this;if(!c.length)break;(i[_+1&3]||i[_+2&3]||i[_+3&3])&&(n=i,f=_)}for(;c.data!==t;)if(e=c,!(c=c.next))return this;return(r=c.next)&&delete c.next,e?(r?e.next=r:delete e.next,this):i?(r?i[_]=r:delete i[_],(c=i[0]||i[1]||i[2]||i[3])&&c===(i[3]||i[2]||i[1]||i[0])&&!c.length&&(n?n[f]=c:this._root=c),this):(this._root=r,this)}function l(t){for(var i=0,n=t.length;i<n;++i)this.remove(t[i]);return this}function _(){return this._root}function f(){var t=0;return this.visit(function(i){if(!i.length)do{++t}while(i=i.next)}),t}function c(t){var i,n,e,r,s,h,a=[],u=this._root;for(u&&a.push(new o(u,this._x0,this._y0,this._x1,this._y1));i=a.pop();)if(!t(u=i.node,e=i.x0,r=i.y0,s=i.x1,h=i.y1)&&u.length){var l=(e+s)/2,_=(r+h)/2;(n=u[3])&&a.push(new o(n,l,_,s,h)),(n=u[2])&&a.push(new o(n,e,_,l,h)),(n=u[1])&&a.push(new o(n,l,r,s,_)),(n=u[0])&&a.push(new o(n,e,r,l,_))}return this}function x(t){var i,n=[],e=[];for(this._root&&n.push(new o(this._root,this._x0,this._y0,this._x1,this._y1));i=n.pop();){var r=i.node;if(r.length){var s,h=i.x0,a=i.y0,u=i.x1,l=i.y1,_=(h+u)/2,f=(a+l)/2;(s=r[0])&&n.push(new o(s,h,a,_,f)),(s=r[1])&&n.push(new o(s,_,a,u,f)),(s=r[2])&&n.push(new o(s,h,f,_,l)),(s=r[3])&&n.push(new o(s,_,f,u,l))}e.push(i)}for(;i=e.pop();)t(i.node,i.x0,i.y0,i.x1,i.y1);return this}function y(t){return t[0]}function d(t){return arguments.length?(this._x=t,this):this._x}function v(t){return t[1]}function p(t){return arguments.length?(this._y=t,this):this._y}function w(t,i,n){var e=new N(null==i?y:i,null==n?v:n,NaN,NaN,NaN,NaN);return null==t?e:e.addAll(t)}function N(t,i,n,e,r,s){this._x=t,this._y=i,this._x0=n,this._y0=e,this._x1=r,this._y1=s,this._root=void 0}function g(t){for(var i={data:t.data},n=i;t=t.next;)n=n.next={data:t.data};return i}var A=w.prototype=N.prototype;A.copy=function(){var t,i,n=new N(this._x,this._y,this._x0,this._y0,this._x1,this._y1),e=this._root;if(!e)return n;if(!e.length)return n._root=g(e),n;for(t=[{source:e,target:n._root=new Array(4)}];e=t.pop();)for(var r=0;r<4;++r)(i=e.source[r])&&(i.length?t.push({source:i,target:e.target[r]=new Array(4)}):e.target[r]=g(i));return n},A.add=i,A.addAll=e,A.cover=r,A.data=s,A.extent=h,A.find=a,A.remove=u,A.removeAll=l,A.root=_,A.size=f,A.visit=c,A.visitAfter=x,A.x=d,A.y=p,t.quadtree=w,Object.defineProperty(t,"__esModule",{value:!0})});
...
},{"d3-color":8,"d3-interpolate":20}],26:[function(require,module,exports){
...
},{"d3-array":4,"d3-format":17,"d3-interpolate":20,"d3-time":30,"d3-time-format":29}],27:[function(require,module,exports){
...
},{"d3-color":8,"d3-dispatch":11,"d3-ease":14,"d3-interpolate":20,"d3-selection":27,"d3-timer":31}],33:[function(require,module,exports){
